...
public class GUI extends JFrame {
    ...
    private void npcSpieleZug() {
        ...
        // Stichansage berechnen
        spieler2.angesagteStiche = npc.berechneStichAnzahl(spieler2.hand, trumpf.getFarbe(), runde, spieler1.ansage);

        if (spieler2.hand.isEmpty()) return;

        Farbe angespielteFarbe = null;

        if (mitte1 != null) {
            angespielteFarbe = mitte1.getFarbe();
        }
        Karte hoehste;
    ...
    private void ansagePhase() {
        ...
        // NPC sagt an
        spieler2.ansage = npc.berechneStichAnzahl(spieler2.hand, trumpf.getFarbe(), runde, spieler1.ansage);
